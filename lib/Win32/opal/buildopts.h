 ...
 * $Revision: 28258 $
 * $Author: rjongbloed $
 * $Date: 2012-08-28 04:55:29 +0000 (Tue, 28 Aug 2012) $
 */
...
#if OPAL_T38_CAPABILITY && OPAL_PTLIB_ASN
  #define OPAL_FAX 1
#endif
...
#if OPAL_JAVA
  #if defined(_MSC_VER)
    #pragma include_alias(<jni.h>,    </include/jni.h>)
    #pragma include_alias("jni_md.h", "/include/win32/jni_md.h")
  #endif
#endif

 ...
 * $Revision: 28459 $
 * $Author: rjongbloed $
 * $Date: 2012-10-04 11:31:39 +0000 (Thu, 04 Oct 2012) $
 */
...
class VP8Encoder : public PluginVideoEncoder<VP8_CODEC>
{
  ...
  public:
    ...
    virtual bool Construct()
    {
      ...
      PTRACE(4, MY_CODEC_LOG, "Encoder opened: " << vpx_codec_version_str() << ", revision $Revision: 28459 $");
      return true;
    }
...
class VP8Decoder : public PluginVideoDecoder<VP8_CODEC>
{
  ...
  public:
    ...
    virtual bool Construct()
    {
      ...
      PTRACE(4, MY_CODEC_LOG, "Decoder opened: " << vpx_codec_version_str() << ", revision $Revision: 28459 $");
      return true;
    }
